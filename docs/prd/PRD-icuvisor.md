...
- `propose_annual_training_plan` — read-only deterministic season-plan proposal from caller-provided goal date, load/hour targets, caps, sports, and strength context. Returns proposed phases, weekly load/time targets, recovery weeks, race anchors, assumptions, warnings, and projection-ready weekly targets without writing calendar data.
