...
The generated tool catalog is the source of truth for the current registered tool count. As of the current generated website data, the catalog has 71 tools total: 30 in `core` and 41 additional `full` tools behind `ICUVISOR_TOOLSET=full`.
