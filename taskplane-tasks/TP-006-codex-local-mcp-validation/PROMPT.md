...
- You may not use `mvilanova/intervals-mcp-server` source code as an implementation reference because it is GPLv3. Do not read, copy, paraphrase, transliterate, or port its code.
