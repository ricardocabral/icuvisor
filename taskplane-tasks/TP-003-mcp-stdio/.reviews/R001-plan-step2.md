...
- The Step 1 discoveries give Step 2 enough direction: pin `github.com/modelcontextprotocol/go-sdk/mcp` to **v1.3.1** to preserve the repository's current `go 1.23` baseline.
