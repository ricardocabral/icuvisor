...
- The registry boundary remains SDK-free in `internal/tools`, with `internal/mcp` responsible for adapting tool definitions to `github.com/modelcontextprotocol/go-sdk`.
