...
- `ROADMAP.md` v0.2
- Forum thread 123739 posts #49, #56–#58 references
...
- `mvilanova/intervals-mcp-server` is GPLv3 — do not read its `sleepRating` collapse logic or any wellness handling; reimplement from public API behavior.
