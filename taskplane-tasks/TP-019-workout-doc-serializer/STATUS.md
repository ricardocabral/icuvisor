...
| 2026-05-13 13:06 | Worker iter 1  | done in 1312s, tools: 90                |
| 2026-05-13 13:06 | Task complete  | .DONE created                           |
...
- Upstream DSL/API references recorded for TP-019:
  ...
  - Workout Builder Syntax Quick Guide (duration/distance, target families/ranges, cadence, ramps, freeride, repeats, cue text, timed prompts).
  - Original Workout builder announcement (plain-text workout steps, percentages, ranges, ramps, repeat examples).
  - API asymmetry discussion (public report that JSON `workout_doc.steps` is not accepted as the write representation).
