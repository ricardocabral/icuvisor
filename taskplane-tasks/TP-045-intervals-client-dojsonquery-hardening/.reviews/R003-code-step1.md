...
The Step 2 implementation should keep the two cautions from R002 in mind: lock down success close-error precedence in tests/comments, and ensure oversize/malformed-body early returns still close the response body in the same loop iteration.
