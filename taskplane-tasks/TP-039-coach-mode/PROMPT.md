...
2. **`list_athletes`** read tool — returns the coach's roster from the upstream coach endpoint (PRD §7.2.C; mvilanova's surface lacks this — verify the intervals.icu endpoint via black-box probe as part of Step 1).
