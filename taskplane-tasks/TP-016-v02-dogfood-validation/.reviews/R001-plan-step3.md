...
- The plan keeps external athlete data local and explicitly forbids collecting API keys, athlete IDs, raw MCP/client logs, transcripts, screenshots with values, exact dates, exact load/threshold values, activity names, and private comments/messages.
