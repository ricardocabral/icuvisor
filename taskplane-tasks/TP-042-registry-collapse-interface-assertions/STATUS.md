...
| 12 | `ApplyTrainingPlanClient` (`apply_training_plan.go`) | embeds workout library/events/event writer | `newApplyTrainingPlanTool` | conditional; capability passed to tool | no |
