...
1. **Record the actual backend selection and evidence.**
   - Prefer `github.com/zalando/go-keyring` unless a blocking issue is found.
   - Record the module/version and release date. Current module data shows `v0.2.8`, tagged `2026-03-23T12:00:09Z`.
   - Record license review, including transitive deps: `zalando/go-keyring` MIT, `github.com/danieljoos/wincred` MIT, `github.com/godbus/dbus/v5` BSD-style, `golang.org/x/sys` BSD-style.
