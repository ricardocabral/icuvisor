...
Land the non-destructive event-side writes: planned workouts and races (`add_or_update_event`), manual pairing of activities to planned events when auto-pair misses (`link_activity_to_event`, forum #97), and free-text activity annotations (`add_activity_message`).
