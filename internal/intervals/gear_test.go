...
func TestListGearSendsCollectionPathAndDecodesFixture(t *testing.T) {
	...
	if gear[1].ID != "shoe-7" || gear[1].Name != nil || gear[1].Retired == nil || *gear[1].Retired != "2025-11-30" {
		t.Fatalf("gear[1] = %#v, want string ID, absent name, and retirement date", gear[1])
	}
}
